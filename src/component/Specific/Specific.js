...
export default props => {
  ...
  if (!props.currentDiary.content || props.list)
  ...
  return (
    <div id="Specific">
      <button
        className="button"
        onClick={async () => {
          if (props.appChangeState) {
            await props.appChangeState(props.currentDiary);
            await props.deleteDiary();
            props.handleState('list', true);
          } else {
            props.deleteDiary();
          }
        }}
      ...
      <button
        ...
        onClick={() => {
          ...
          if (props.appChangeState) props.appChangeState(props.currentDiary);
